...
Bureaucrat::Bureaucrat(const std::string &givenName, int givenGrade) : name(givenName)
{
    std::cout << "Bureaucrat constructor called" << std::endl;
    applyGrade(givenGrade);
}

Bureaucrat::Bureaucrat(const Bureaucrat &old_crat) : name(old_crat.getName())
{
    *this = old_crat;
}
